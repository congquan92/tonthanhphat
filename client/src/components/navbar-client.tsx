...
function NavItem({ link }: { link: NavLink }) {
    ...
    return (
        <Button variant="ghost" asChild className={isActive ? "font-bold border-b-2 border-black rounded-none" : ""}>
...
function MobileNavItem({ link, onClose }: { link: NavLink; onClose: () => void }) {
                        ...
                        {link.submenu.map((subItem) => {
                            ...
                            return (
                                <Button
                                    key={subItem.href}
                                    variant="ghost"
                                    className={`justify-start ${isSubActive ? "font-bold bg-gray-900 text-white hover:bg-gray-800 hover:text-white" : "text-muted-foreground"}`}
                                    asChild
                                >
    ...
    return (
        <Button variant="ghost" className={`justify-start ${isActive ? "font-bold bg-gray-100" : ""}`} asChild>
