...
import { ArrowLeft, Save, Upload, X, RefreshCw, Eye } from "lucide-react";
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500">Tạo bài viết tin tức mới với editor chuyên nghiệp</p>
                </div>
            </div>
                        ...
                        <Card className="rounded-2xl border-0 bg-white shadow-lg dark:bg-slate-800">
                            ...
                            <CardContent className="space-y-4">
                                <div>
                                    ...
                                    <Input id="title" value={formData.title} onChange={(e) => handleTitleChange(e.target.value)} placeholder="Nhập tiêu đề bài viết..." className="mt-1.5" />
                                </div>
                                <div>
